...
I also teach what I build. I run [The College of AI](https://www.youtube.com/@TheCollegeOfAI) on YouTube and have taught Python, Agentic AI, Docker, and N8N to 500+ students across multiple cohorts.
...
<p align="center">
  <a href="https://skillicons.dev">
    <img src="https://skillicons.dev/icons?i=docker,kubernetes,aws,azure,linux,git,github,cloudflare&perline=8" alt="DevOps and Cloud" />
  </a>
</p>
...
|:--------|:-----------|:------|
| **Observator** | Government-grade B2G labour market intelligence platform with an 18-agent LangGraph pipeline, serving real-time workforce analytics with UAE data sovereignty compliance | React 18, FastAPI, PostgreSQL, DuckDB, TimescaleDB, Qdrant, Azure AKS |
| **NextMovePath** | Multi-agent immigration consultant system with eligibility assessment, CRS scoring, document checklist generation, and RAG over official IRCC guidelines | LangGraph, FastAPI, FAISS, GPT-4 |
| **DocumedAI** | AI-powered medical documentation platform that automates clinical note generation and report interpretation using multi-modal RAG | FastAPI, LangChain, OpenAI, RAG |
